...
```html
<div class="bg-white dark:bg-gray-900">Content with light/dark background</div>

<div class="bg-gray-100 dark:bg-gray-800">Subtle background</div>
```
...
<span class="text-gray-500 dark:text-gray-400"> Subtle text </span>
```
...
<!-- Secondary button -->
<button
  class="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white px-4 py-2 rounded"
>
  Secondary Button
</button>
...
<!-- Outline button -->
<button
  class="border-2 border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-4 py-2 rounded"
>
  Outline Button
</button>
```
...
<select
  class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
>
...
<!-- Info alert -->
<div
  class="bg-blue-100 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-400 p-4"
>
...
<!-- Success alert -->
<div
  class="bg-green-100 dark:bg-green-900/20 border-l-4 border-green-500 dark:border-green-400 p-4"
>
...
<!-- Warning alert -->
<div
  class="bg-yellow-100 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-400 p-4"
>
...
<!-- Error alert -->
<div
  class="bg-red-100 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-400 p-4"
>
  <p class="text-red-900 dark:text-red-200">An error occurred!</p>
</div>
```
...
```html
<div class="bg-white/95 dark:bg-gray-900/95">Semi-transparent background</div>

<div class="text-gray-900/80 dark:text-white/80">Text with opacity</div>
...
<div
  class="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 p-4 rounded transition-colors"
>
  Hoverable card
</div>
```
