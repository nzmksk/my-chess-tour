...
- [ ] **[S7]** Apply migration `009_identity_indirection.sql` (ties to #161), then run `db/tests/identity_indirection.sql` and check the query plans on `/my/tournaments` and checkout for regression from the `app_user_id()` lookup. 🔴
